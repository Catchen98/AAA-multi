...
def draw_weightNloss_graph(
    ...
    for seq in dataset:
        ...
        error_path = eval_dir / algorithm / dataset_name / f"{seq_name}.csv"
        error = pd.read_csv(error_path, header=0)
        ...
        # draw anchor line
        for i in loss.index:
            weight_ax.axvline(x=i, color="gray", linestyle="--", linewidth=1, alpha=1)
